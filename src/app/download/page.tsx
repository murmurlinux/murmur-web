      ...
      <div className="pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <a href="https://github.com/murmurlinux/murmur/releases/download/v0.1.1/Murmur_0.1.1_amd64.deb" className="cta-grad text-base font-mono flex items-center gap-3"><DownloadIcon /> Download .deb</a>
            <a href="https://github.com/murmurlinux/murmur/releases/download/v0.1.1/Murmur_0.1.1_amd64.AppImage" className="glass px-8 py-4 text-base font-mono text-glass-white hover:bg-white/5 transition-colors flex items-center gap-3 rounded-xl"><DownloadIcon /> Download .AppImage</a>
          </div>
